    ...
    <div className="p-4">
      ...
      <div className="space-y-1 mb-3 text-sm">
        ...
        <div className="flex items-center text-gray-600 space-x-1">
          <Bed size={18} />
          <span>
            Usable Bed Length: {cmToFeetInches(property.mattressLengthCM)} ({property.mattressLengthCM} cm) - 2 beds (1 footboard)
          </span>
        </div>
        <div className="flex items-center text-gray-600 space-x-1">
          <DollarSign size={18} />
          <span>Price Rating: {priceLabels[property.priceRange]}</span>
        </div>
      </div>
    ...
    <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-white p-5 rounded-xl shadow-lg mb-5">
        ...
        <div className="grid sm:grid-cols-3 gap-y-1 gap-x-4 text-lg">
            ...
            <div className="font-semibold">Price Rating:</div>
            <div className="col-span-2">{priceLabels[property.priceRange]}</div>
        </div>
      </div>
